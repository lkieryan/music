...
use anyhow::Result;
use super::{MusicSource, UnifiedSong, SourceSearchResult, MusicSourceType, SongMetadata};
...
impl KugouSource {
    pub fn new() -> Self {
        Self {
            ...
            base_url: "https://mobilecdnbj.kugou.com".to_string(),
        }
    }
}
