  ...
  return (
    <div className="m-auto flex min-h-full max-w-prose select-text flex-col p-8 pt-24">
      ...
      <div className="center flex flex-col">
        ...
        <h2 className="mb-4 mt-12 text-2xl">Sorry, Music has encountered an error</h2>
      </div>
      <h3 className="text-xl">{message}</h3>

      <p className="my-8">
        Music has a temporary problem, click the button below to try reloading the app or
        another solution?
      </p>
...
export const FeedbackIssue = (props: { message: string, stack: string | null | undefined, error?: unknown }) => (
  <p className="mt-8">
