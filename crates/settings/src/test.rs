...
#[test]
fn test_settings_init() -> Result<()> {
    let test_dir = setup_test_dir();

    let prefs = SettingsConfig::new(test_dir.clone())?;
...
#[test]
fn test_secure_settings() -> Result<()> {
    let test_dir = setup_test_dir();
...
#[test]
fn test_update_settings() -> Result<()> {
    let test_dir = setup_test_dir();
...
#[test]
fn test_settings_events() -> Result<()> {
    let test_dir = setup_test_dir();
...
#[test]
fn test_remove_settings() -> Result<()> {
    let test_dir = setup_test_dir();
